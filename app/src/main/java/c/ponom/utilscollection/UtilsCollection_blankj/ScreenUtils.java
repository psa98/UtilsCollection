...
public final class ScreenUtils {
    ...
    public int calculateDistanceByX(View view) {
        ...
        return getScreenWidth(view.getContext()) - point[0];
    }
    ...
    public int calculateDistanceByY(View view) {
        int[] point = new int[2];
        view.getLocationOnScreen(point);
        return getScreenHeight(view.getContext()) - point[1];
    }
    ...
    public static Bitmap screenShot(@NonNull final Activity activity, boolean isDeleteStatusBar) {
        ...
        if (isDeleteStatusBar) {
            int statusBarHeight = BarUtils.getStatusBarHeight(decorView.getContext());
