...
public final class KeyboardUtils {
    ...
    private static int getDecorViewInvisibleHeight(@NonNull final Window window) {
        ...
        if (delta <= BarUtils.getNavBarHeight(context) + BarUtils.getStatusBarHeight(context)) {
    ...
    private static int getContentViewInvisibleHeight(final Window window) {
        ...
        if (delta <= BarUtils.getStatusBarHeight(window.getContext()) + BarUtils.getNavBarHeight(window.getContext())) {
            return 0;
        }
        return delta;
    }
