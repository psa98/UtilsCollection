...
public class VolumeUtils {
     ...
     * @return the volume
     */
    public static int getVolume(int streamType, Context context) {
     ...
     *                   </ul>
     */
    public static void setVolume(int streamType, int volume, int flags, Context context) {
        AudioManager am = (AudioManager) context.getSystemService(Context.AUDIO_SERVICE);
        try {
     ...
     * @return the maximum volume
     */
    public static int getMaxVolume(int streamType, Context context) {
        AudioManager am = (AudioManager) context.getSystemService(Context.AUDIO_SERVICE);
     ...
     * @return the minimum volume
     */
    public static int getMinVolume(int streamType, Context context) {
        AudioManager am = (AudioManager) context.getSystemService(Context.AUDIO_SERVICE);
