...
public class BarUtils {
         ...
         * @param fakeStatusBar The fake status bar view.
         */
        public static void setStatusBarCustom(@NonNull final View fakeStatusBar,Activity activity) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) return;
            if (activity == null) return;
            transparentStatusBar(activity);
            fakeStatusBar.setVisibility(View.VISIBLE);
        ...
        public static void setNotificationBarVisibility(final Context context, final boolean isVisible) {
            String methodName;
            if (isVisible) {
            ...
            invokePanels(methodName, context);
        }

        private static void invokePanels(final String methodName, Context context) {
            try {
        ...
        public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
            ...
            for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
                ...
                if (id != View.NO_ID) {
                    String resourceEntryName = getResNameById(window.getContext(), id);
